...
chItems = document.querySelectorAll( '.unviewable' ); //selectionne les div //
referencesMasonry = document.querySelector( '#references-masonry' ); //selectionne le container//
console.log( referencesMasonry );


window.addEventListener( 'scroll', function () {
    if ( window.pageYOffset >= referencesMasonry.offsetTop -500 ) {
        console.log( 'pour' );
        for(var i = 0; i < 3; i++ ) {
             console.log(chItems[i]);
             chItems[i].classList.remove('unviewable');
            chItems[i].classList.add( 'reference-item' );
            chItems[i].style.transition = "1.5s ease";
        } ;
    } 

    if ( window.pageYOffset >= chItems[3].offsetTop -400) {
        console.log( 'pour' );
        for(var i = 3; i < 6; i++ ) {
             console.log(chItems[i]);
             chItems[i].classList.remove('unviewable');
    ...
    if ( window.pageYOffset >= chItems[6].offsetTop - 400) {
        console.log( 'pour' );
        for(var i = 6; i < 8; i++ ) {
             console.log(chItems[i]);
             chItems[i].classList.remove('unviewable');
...
// chItems = document.querySelectorAll( '.unviewable1' ); //selectionne les div //
// referencesMasonry = document.querySelector( '#references-masonry' ); //selectionne le container//
// console.log( referencesMasonry );


// window.addEventListener( 'scroll', function () {
//     if ( window.pageYOffset >= referencesMasonry.offsetTop ) {
//         console.log( 'projet' );
//         chItems.forEach( element => {
//             element.classList.remove('unviewable1');
...
// chItems = document.querySelectorAll( '.unviewable2' ); //selectionne les div //
// referencesMasonry = document.querySelector( '#references-masonry' ); //selectionne le container//
// console.log( referencesMasonry );
...
//         console.log( 'projet' );
//         chItems.forEach( element => {
//             element.classList.remove('unviewable2');
//             element.classList.add( 'reference-item1');
